...
train.py, envu.py is the main code for train and evaluation
transformer.py, tokeners.py, layernorm.py, encoder.py, decoder.py, attention.py is the model structure
loss_curve.png is the picture of training loss_curve.
